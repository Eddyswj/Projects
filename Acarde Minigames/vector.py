...
class vector():
	...
	# _changes = {"up":["right", "left"], "left":["up", "down"], "down":["left", "right"], "right":["down", "up"]}
	...
	@property
	def changes(self):
		"""Getter method for vector's possible direction changes
		"""
		return self._changes[self._dir]
	...
	def __eq__(self, other):
		"""Overrides __eq__ method to let '==' operator return True for 2 vectors as long as they have
