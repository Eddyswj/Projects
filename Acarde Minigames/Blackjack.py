...
def deck_count():
    ...
    if len(game_deck) <= (0.33 * deck_size):
        ...
        game_deck = copy.deepcopy(single_deck * decks_used)
...
def restart_game():
    ...
    while player_hand_value < 21 and len(player_hand) < 5: #Player turn - Hit or Stand if player hand has a value of less than 25 and less than 5 cards
...
def main(): 
    ...
    game_deck = copy.copy(single_deck * decks_used)
    shuffle_deck(game_deck)
